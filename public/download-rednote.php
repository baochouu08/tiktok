...
$canonicalUrl = getBaseUrl() . "/download-rednote.php";
...
$skipAppJs = true;  // Don't load app.js - use rednote-standalone.js instead
...
<div id="videoResult" class="video-result" style="display: none;">
    <div class="result-card">
        <img id="videoCover" class="video-cover" src="" alt="Content preview" style="display: none;">
        <div class="video-info">
            ...
            <div id="imagesGallery" class="images-gallery" style="display: none;">
                <h4 style="margin: 15px 0 10px 0; font-size: 16px;">📸 Images</h4>
            ...
            <div class="download-buttons">
                ...
                <button id="downloadAllImagesBtn" class="btn-download btn-secondary" style="display: none;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                        <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" fill="currentColor"/>
                    </svg>Tải tất cả ảnh</button>
            </div>
        </div>
    </div>
</div>
...
<script src="/assets/js/rednote-standalone.js?v=<?php echo time(); ?>" defer></script>
