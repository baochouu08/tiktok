...
// Load meta tags from translations (multilingual SEO) with fallback to config
$pageTitle = pt('page_meta_title') ?: $config['pageTitle'];
$metaDescription = pt('page_meta_description') ?: $config['metaDescription'];
$metaKeywords = pt('page_meta_keywords') ?: $config['metaKeywords'];
$canonicalUrl = getBaseUrl() . "/download-tiktok.php";
...
<section class="seo-content">
    ...
    <div class="seo-section">
        <h3><?php echo pt('seo_section_8_title'); ?></h3>
        <p><?php echo pt('seo_section_8_p1'); ?></p>
        <p><?php echo pt('seo_section_8_p2'); ?></p>
    </div>

    <div class="seo-section">
        <h3><?php echo pt('seo_section_9_title'); ?></h3>
        <p><?php echo pt('seo_section_9_p1'); ?></p>
        <p><?php echo pt('seo_section_9_p2'); ?></p>
    </div>


    <div class="related-platforms">
        <h3><?php echo pt('seo_related_platforms_title'); ?></h3>
        <p><?php echo pt('seo_related_platforms_intro'); ?></p>
        <ul class="platform-links">
            <li><a href="/download-instagram">Download Instagram Videos & Reels</a> - Save Instagram posts, Reels, Stories, and IGTV videos</li>
            <li><a href="/download-youtube">Download YouTube Videos</a> - Download YouTube videos in 4K, 1080p, or convert to MP3</li>
            <li><a href="/download-facebook">Download Facebook Videos</a> - Save Facebook videos and Reels in HD quality</li>
            <li><a href="/download-twitter">Download Twitter/X Videos</a> - Download videos and GIFs from Twitter/X posts</li>
            <li><a href="/download-douyin">Download Douyin Videos</a> - Save videos from Chinese TikTok (抖音)</li>
            <li><a href="/download-bilibili">Download Bilibili Videos</a> - Download anime and videos from B站</li>
        </ul>
    </div>
</section>
...
.related-platforms {
    background: linear-gradient(135deg, #f5f4f1 0%, #ffffff 100%);
    border-radius: 12px;
    padding: 30px;
    margin-top: 40px;
}
